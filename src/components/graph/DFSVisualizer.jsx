...
const DFSVisualizer = ({ onBack }) => {
  ...
  const getNodeColor = (nodeId) => {
    ...
    if (stack.includes(nodeId)) return '#f59e0b'; // yellow
    return '#6b7280'; // gray
  };
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Explore graph by going as deep as possible before backtracking using a stack
          </p>
        </div>
